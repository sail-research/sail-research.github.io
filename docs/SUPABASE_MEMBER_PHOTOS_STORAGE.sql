...
--
-- The registration page uploads photos with the publishable key to this public
-- bucket, then stores the resulting public URL in public.lab_members.image_url.
